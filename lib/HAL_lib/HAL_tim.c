...
////////////////////////////////////////////////////////////////////////////////
/// @brief  Deinitializes the timer peripheral registers to their default reset
///         values.
/// @param  tim: where timer can be 1, 2, 3, 4, 5, 8, 14, 16 or 17 to select the
///         timer peripheral.
/// @retval None.
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
/// @brief  Initializes the timer Time Base Unit peripheral according to
///         the specified parameters in the pInitStruct.
/// @param  tim: where timer can be 1, 2, 3, 4, 5, 6, 7, 8, 14, 16 or 17 to
///         select the timer peripheral.
/// @param  pInitStruct: pointer to a TIM_TimeBaseInitTypeDef
///         structure that contains the configuration information for the
///         specified timer peripheral.
/// @retval None.
////////////////////////////////////////////////////////////////////////////////
void TIM_TimeBaseInit(TIM_TypeDef* tim, TIM_TimeBaseInitTypeDef* pInitStruct)
{
    ...
    WRITE_REG(tim->ARR, pInitStruct->TIM_Period);
    WRITE_REG(tim->PSC, pInitStruct->TIM_Prescaler);
    WRITE_REG(tim->EGR, TIM_PSCReloadMode_Immediate);
}

////////////////////////////////////////////////////////////////////////////////
/// @brief  Initializes the timer channel1 according to the specified
///         parameters in the pInitStruct.
/// @param  tim: where timer can be 1, 2, 3, 4, 5, 8, 14, 16 or 17 to select the
///         timer peripheral.
/// @param  pInitStruct: pointer to a TIM_OCInitTypeDef structure that
///			contains the configuration information for the specified timer
///         peripheral.
/// @retval None.
////////////////////////////////////////////////////////////////////////////////
void TIM_OC1Init(TIM_TypeDef* tim, TIM_OCInitTypeDef* pInitStruct)
{
    ...
    MODIFY_REG(tim->CCER, TIM_CCER_CC1NP, pInitStruct->TIM_OCNPolarity);
    MODIFY_REG(tim->CCER, TIM_CCER_CC1NEN, pInitStruct->TIM_OutputNState);
    MODIFY_REG(tim->CR2, TIM_CR2_OIS1, pInitStruct->TIM_OCIdleState);
    MODIFY_REG(tim->CR2, TIM_CR2_OIS1N, pInitStruct->TIM_OCNIdleState);
}

////////////////////////////////////////////////////////////////////////////////
/// @brief  Initializes the timer channel2 according to the specified
///         parameters in the pInitStruct.
/// @param  tim: where timer can be  1, 2, 3, 4, 5 or 8 to select the timer
///         peripheral.
/// @param  pInitStruct: pointer to a TIM_OCInitTypeDef structure that
///			contains the configuration information for the specified timer
///         peripheral.
/// @retval None.
////////////////////////////////////////////////////////////////////////////////
void TIM_OC2Init(TIM_TypeDef* tim, TIM_OCInitTypeDef* pInitStruct)
{
...
////////////////////////////////////////////////////////////////////////////////
/// @brief  Initializes the timer Channel3 according to the specified
///         parameters in the pInitStruct.
/// @param  tim: where timer can be  1, 2, 3, 4, 5 or 8 to select the timer
///         peripheral.
/// @param  pInitStruct: pointer to a TIM_OCInitTypeDef structure that
...
/// @retval None.
////////////////////////////////////////////////////////////////////////////////
void TIM_OC3Init(TIM_TypeDef* tim, TIM_OCInitTypeDef* pInitStruct)
{
...
////////////////////////////////////////////////////////////////////////////////
/// @brief  Initializes the timer Channel4 according to the specified
///         parameters in the pInitStruct.
/// @param  tim: where timer can be  1, 2, 3, 4, 5 or 8 to select the timer
///         peripheral.
/// @param  pInitStruct: pointer to a TIM_OCInitTypeDef structure that
...
/// @retval None.
////////////////////////////////////////////////////////////////////////////////
void TIM_OC4Init(TIM_TypeDef* tim, TIM_OCInitTypeDef* pInitStruct)
{
...
////////////////////////////////////////////////////////////////////////////////
/// @brief  Initializes the timer peripheral according to the specified
///         parameters in the pInitStruct.
/// @param  tim: where timer can be 1, 2, 3, 4, 5, 8, 14, 16 or 17 to select the
///         timer peripheral.
...
/// @retval None.
////////////////////////////////////////////////////////////////////////////////
void TIM_ICInit(TIM_TypeDef* tim, TIM_ICInitTypeDef* pInitStruct)
{
...
////////////////////////////////////////////////////////////////////////////////
/// @brief  Configures the timer peripheral according to the specified
...
/// @retval None.
////////////////////////////////////////////////////////////////////////////////
void TIM_PWMIConfig(TIM_TypeDef* tim, TIM_ICInitTypeDef* pInitStruct)
{
...
////////////////////////////////////////////////////////////////////////////////
/// @brief  Configures the: Break feature, dead time, Lock level, the OSSI, the
///         OSSR State and the AOE(automatic output enable).
/// @param  tim: where timer can be 1 or 8 to select the timer
/// @param  pInitStruct: pointer to a TIM_BDTRInitTypeDef structure that
///         contains the BDTR Register configuration  information for the timer
///         peripheral.
/// @retval None.
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
/// @brief  Fills each pInitStruct member with its default value.
/// @param  pInitStruct : pointer to a TIM_OCInitTypeDef structure which will be
///         initialized.
/// @retval None.
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
/// @brief  Fills each pInitStruct member with its default value.
/// @param  pInitStruct: pointer to a TIM_ICInitTypeDef structure which will be
///         initialized.
/// @retval None.
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
/// @brief  Fills each pInitStruct member with its default value.
/// @param  pInitStruct: pointer to a TIM_BDTRInitTypeDef structure which will
///         be initialized.
/// @retval None.
////////////////////////////////////////////////////////////////////////////////
...
/// @param  tim: where timer can be 1 to 17 to select the timer peripheral.
/// @param  state: new state of the timer peripheral.
...
/// @param  tim: where timer can be 1, 8, 16 or 17 to select the timer
///         peripheral.
/// @param  state: new state of the timer peripheral Main Outputs.
///         This parameter can be: ENABLE or DISABLE.
/// @retval None.
////////////////////////////////////////////////////////////////////////////////
...
/// @param  tim: where timer can be 1, 2, 3, 4, 5, 8, 14, 16 or 17 to select the
///         timer peripheral.
/// @param  it: specifies the timer interrupts sources to be enabled or
///         disabled.
///         This parameter can be any combination of the following values:
///    @arg TIM_IT_Update: timer update Interrupt source
///    @arg TIM_IT_CC1: timer Capture Compare 1 Interrupt source
///    @arg TIM_IT_CC2: timer Capture Compare 2 Interrupt source
///    @arg TIM_IT_CC3: timer Capture Compare 3 Interrupt source
///    @arg TIM_IT_CC4: timer Capture Compare 4 Interrupt source
///    @arg TIM_IT_COM: timer Commutation Interrupt source
///    @arg TIM_IT_Trigger: timer Trigger Interrupt source
///    @arg TIM_IT_Break: timer Break Interrupt source
/// @note
...
/// @param  state: new state of the timer interrupts.
///         This parameter can be: ENABLE or DISABLE.
/// @retval None.
////////////////////////////////////////////////////////////////////////////////
void TIM_ITConfig(TIM_TypeDef* tim, TIMIT_TypeDef it, FunctionalState state)
{
...
/// @param  tim: where timer can be 1, 2, 3, 4, 5, 8, 16 or 17 to select the
///         timer peripheral.
...
///         This parameter can be any combination of the following values:
///    @arg TIM_DMA_Update: timer update Interrupt source
///    @arg TIM_DMA_CC1: timer Capture Compare 1 DMA source
///    @arg TIM_DMA_CC2: timer Capture Compare 2 DMA source
///    @arg TIM_DMA_CC3: timer Capture Compare 3 DMA source
///    @arg TIM_DMA_CC4: timer Capture Compare 4 DMA source
///    @arg TIM_DMA_COM: timer Commutation DMA source
///    @arg TIM_DMA_Trigger: timer Trigger DMA source
...
/// @param  tim: where timer can be 1, 2, 3, 4 or 5 to select the timer
///         peripheral.
    ...
    TIMETP_Typedef polarity, u16 filter)
{
    ...
    MODIFY_REG(tim->SMCR, TIM_SMCR_SMS, TIM_SlaveMode_External1);
}
...
/// @param  reloadMode: specifies the timer Prescaler Reload mode
///         This parameter can be one of the following values:
///    @arg TIM_PSCReloadMode_Update: The Prescaler is loaded at the update
///         event.
...
///         This parameter can be one of the following values:
///    @arg TIM_CounterMode_Up: timer Up Counting Mode
///    @arg TIM_CounterMode_Down: timer Down Counting Mode
///    @arg TIM_CounterMode_CenterAligned1: timer Center Aligned Mode1
///    @arg TIM_CounterMode_CenterAligned2: timer Center Aligned Mode2
///    @arg TIM_CounterMode_CenterAligned3: timer Center Aligned Mode3
/// @retval None.
////////////////////////////////////////////////////////////////////////////////
void TIM_CounterModeConfig(TIM_TypeDef* tim, TIMCOUNTMODE_Typedef counterMode)
{
    MODIFY_REG(tim->CR1, TIM_CR1_CMS | TIM_CR1_DIR, counterMode);
}
...
/// @param  tim: where timer can be 1, 2, 3, 4, 5 or 8 to select the timer
///         peripheral.
/// @param  encoderMode: specifies the tim Encoder Mode.
///         This parameter can be one of the following values:
///    @arg TIM_EncoderMode_TI1: Counter counts on TI1FP1 edge depending on
///         TI2FP2 level.
///    @arg TIM_EncoderMode_TI2: Counter counts on TI2FP2 edge depending on
///         TI1FP1 level.
///    @arg TIM_EncoderMode_TI12: Counter counts on both TI1FP1 and TI2FP2 edges
...
/// @param  tim: where timer can be 1, 2, 3, 4, 5, 8, 14, 16 or 17 to select the
///         timer peripheral.
/// @param  forcedAction: specifies the forced Action to be set to the output
///         waveform.
///         This parameter can be one of the following values:
...
/// @retval None.
////////////////////////////////////////////////////////////////////////////////
void TIM_ForcedOC1Config(TIM_TypeDef* tim, TIMOCMODE_Typedef forcedAction)
{
    MODIFY_REG(tim->CCMR1, TIM_CCMR1_OC1M, forcedAction);
}
...
/// @retval None.
////////////////////////////////////////////////////////////////////////////////
void TIM_ForcedOC2Config(TIM_TypeDef* tim, TIMOCMODE_Typedef forcedAction)
{
    MODIFY_REG(tim->CCMR1, TIM_CCMR1_OC2M, forcedAction << 8);
}
...
/// @retval None.
////////////////////////////////////////////////////////////////////////////////
void TIM_ForcedOC3Config(TIM_TypeDef* tim, TIMOCMODE_Typedef forcedAction)
{
    MODIFY_REG(tim->CCMR2, TIM_CCMR2_OC3M, forcedAction);
}
...
/// @retval None.
////////////////////////////////////////////////////////////////////////////////
void TIM_ForcedOC4Config(TIM_TypeDef* tim, TIMOCMODE_Typedef forcedAction)
{
    MODIFY_REG(tim->CCMR2, TIM_CCMR2_OC4M, forcedAction << 8);
}

////////////////////////////////////////////////////////////////////////////////
/// @brief  Enables or disables timer peripheral Preload register on ARR.
/// @param  tim: where timer can be 1, 2, 3, 4, 5, 8, 14, 16 or 17 to select the
///         timer peripheral.
/// @param  state: new state of the timer peripheral Preload register
///         This parameter can be: ENABLE or DISABLE.
/// @retval None.
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
/// @brief  Selects the timer peripheral Commutation event.
/// @param  tim: where timer can be 1, 8, 16 or 17 to select the timer
///         peripheral.
...
////////////////////////////////////////////////////////////////////////////////
/// @brief  Selects the timer peripheral Capture Compare DMA source.
/// @param  tim: where timer can be 1, 2, 3, 4, 5, 8, 16 or 17 to select the
///         timer peripheral.
...
////////////////////////////////////////////////////////////////////////////////
/// @brief  Sets or Resets the timer peripheral Capture Compare Preload Control
///         bit.
/// @param  tim: where timer can be 1, 2, 3, 4, 5 or 8 to select the tim
///         peripheral.
...
////////////////////////////////////////////////////////////////////////////////
/// @brief  Enables or disables the timer peripheral Preload register on CCR1.
/// @param  tim: where timer can be 1, 2, 3, 4, 5, 8, 14, 16 or 17 to select the
///         timer peripheral.
...
////////////////////////////////////////////////////////////////////////////////
/// @brief  Enables or disables the timer peripheral Preload register on CCR2.
/// @param  tim: where timer can be 1, 2, 3, 4, 5 or 8 to select the timer \
///         peripheral.
/// @param  preload: new state of the timer peripheral Preload register
///         This parameter can be one of the following values:
...
////////////////////////////////////////////////////////////////////////////////
/// @brief  Enables or disables the timer peripheral Preload register on CCR3.
/// @param  tim: where timer can be 1, 2, 3, 4, 5 or 8 to select the timer \
///         peripheral.
/// @param  preload: new state of the timer peripheral Preload register
///         This parameter can be one of the following values:
...
////////////////////////////////////////////////////////////////////////////////
/// @brief  Enables or disables the timer peripheral Preload register on CCR4.
/// @param  tim: where timer can be 1, 2, 3, 4, 5 or 8 to select the timer
///         peripheral.
/// @param  preload: new state of the timer peripheral Preload register
///         This parameter can be one of the following values:
...
{
    MODIFY_REG(tim->CCMR1, TIM_CCMR2_OC4PEN, preload << 8);
}

////////////////////////////////////////////////////////////////////////////////
/// @brief  Configures the timer Output Compare 1 Fast feature.
/// @param  tim: where timer can be 1, 2, 3, 4, 5, 8, 16 or 17 to select the
///         timer peripheral.
/// @param  fast: new state of the Output Compare Fast Enable Bit.
///         This parameter can be one of the following values:
///    @arg TIM_OCFast_Enable: timer output compare fast enable
///    @arg TIM_OCFast_Disable: timer output compare fast disable
/// @retval None.
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
/// @brief  Configures the timer Output Compare 2 Fast feature.
/// @param  tim: where timer can be 1, 2, 3, 4, 5 or 8 to select the timer
///         peripheral.
/// @param  fast: new state of the Output Compare Fast Enable Bit.
///         This parameter can be one of the following values:
...
////////////////////////////////////////////////////////////////////////////////
/// @brief  Configures the timer Output Compare 3 Fast feature.
/// @param  tim: where timer can be 1, 2, 3, 4, 5 or 8 to select the timer
///         peripheral.
/// @param  fast: new state of the Output Compare Fast Enable Bit.
///         This parameter can be one of the following values:
...
////////////////////////////////////////////////////////////////////////////////
/// @brief  Configures the timer Output Compare 4 Fast feature.
/// @param  tim: where timer can be 1, 2, 3, 4, 5 or 8 to select the timer
///         peripheral.
/// @param  fast: new state of the Output Compare Fast Enable Bit.
///         This parameter can be one of the following values:
...
///         This parameter can be one of the following values:
///    @arg TIM_OCClear_Enable: timer Output clear enable
///    @arg TIM_OCClear_Disable: timer Output clear disable
/// @retval None.
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
/// @brief  Configures the timer channel 1 polarity.
/// @param  tim: where timer can be 1, 2, 3, 4, 5, 8, 16 or 17 to select the
///         timer peripheral.
...
////////////////////////////////////////////////////////////////////////////////
/// @brief  Configures the timer Channel 1N polarity.
/// @param  tim: where timer can be 1, 8, 16 or 17 to select the timer
///         peripheral.
...
////////////////////////////////////////////////////////////////////////////////
/// @brief  Configures the timer channel 2 polarity.
/// @param  tim: where timer can be 1, 2, 3, 4, 5 or 8 to select the timer
///         peripheral.
...
////////////////////////////////////////////////////////////////////////////////
/// @brief  Configures the timer Channel 2N polarity.
...
////////////////////////////////////////////////////////////////////////////////
/// @brief  Configures the timer channel 3 polarity.
/// @param  tim: where timer can be 1, 2, 3, 4, 5 or 8 to select the timer
///         peripheral.
...
////////////////////////////////////////////////////////////////////////////////
/// @brief  Configures the timer Channel 3N polarity.
/// @param  tim: where timer can be 1 or 8 to select the timer peripheral.
...
////////////////////////////////////////////////////////////////////////////////
/// @brief  Configures the timer channel 4 polarity.
/// @param  tim: where timer can be 1, 2, 3, 4, 5 or 8 to select the timer
///         peripheral.
...
/// @param  tim: where timer can be 1, 2, 3, 4, 5, 8, 14, 16 or 17 to select the
///         timer peripheral.
/// @param  channel: specifies the timer Channel
///         This parameter can be one of the following values:
///    @arg TIM_Channel_1: timer Channel 1
///    @arg TIM_Channel_2: timer Channel 2
///    @arg TIM_Channel_3: timer Channel 3
///    @arg TIM_Channel_4: timer Channel 4
///    @arg TIM_Channel_5: timer Channel 5(Only for some MM32 TIM1/8)
/// @param  TIM_CCx: specifies the timer Channel CCxE bit new state.
///         This parameter can be: TIM_CCx_Enable or TIM_CCx_Disable.
/// @retval None.
////////////////////////////////////////////////////////////////////////////////
void TIM_CCxCmd(TIM_TypeDef* tim, TIMCHx_Typedef channel, TIMCCxE_Typedef ccxEn)
{
    MODIFY_REG(tim->CCER, TIM_CCER_CC1EN << channel, ccxEn << channel);
}
...
///    @arg TIM_Channel_2: timer Channel 2
///    @arg TIM_Channel_3: timer Channel 3
/// @param  TIM_CCxN: specifies the timer Channel CCxNE bit new state.
...
////////////////////////////////////////////////////////////////////////////////
/// @brief  Selects the timer Output Compare Mode.
/// @note   This function disables the selected channel before changing the
///         Output Compare Mode. User has to enable this channel using
...
///    @arg TIM_Channel_3: timer Channel 3
///    @arg TIM_Channel_4: timer Channel 4
/// @param  mode: specifies the timer Output Compare Mode.
///         This parameter can be one of the following values:
...
////////////////////////////////////////////////////////////////////////////////
/// @brief  Enables or Disables the timer Update event.
/// @param  tim: where timer can be 1, 2, 3, 4, 5, 8, 14, 16 or 17 to select the
///         timer peripheral.
...
////////////////////////////////////////////////////////////////////////////////
/// @brief  Configures the timer Update Request Interrupt source.
/// @param  tim: where timer can be 1, 2, 3, 4, 5, 8, 14, 16 or 17 to select the
///         timer peripheral.
/// @param  source: specifies the Update source.
///         This parameter can be one of the following values:
///    @arg TIM_UpdateSource_Regular:
///         Source of update is the counter overflow / underflow or the setting
///         of UG bit,or an update generation through the slave mode controller.
...
////////////////////////////////////////////////////////////////////////////////
/// @brief  Enables or disables the timer Hall sensor interface.
/// @param  tim: where timer can be 1, 2, 3, 4, 5 or 8 to select the timer
///         peripheral.
...
////////////////////////////////////////////////////////////////////////////////
/// @brief  Selects the timer One Pulse Mode.
/// @param  tim: where timer can be 1, 2, 3, 4, 5, 8, 14, 16 or 17 to select the
///         timer peripheral.
...
////////////////////////////////////////////////////////////////////////////////
/// @brief  Selects the timer Slave Mode.
/// @param  tim: where timer can be 1, 2, 3, 4, 5 or 8 to select the timer
///         peripheral.
...
////////////////////////////////////////////////////////////////////////////////
/// @brief  Sets or Resets the timer Master/Slave Mode.
/// @param  tim: where timer can be 1, 2, 3, 4, 5 or 8 to select the timer
///         peripheral.
...
////////////////////////////////////////////////////////////////////////////////
/// @brief  Sets the timer Counter Register value
/// @param  tim: where timer can be 1, 2, 3, 4, 5, 8, 14, 16 or 17 to select the
///         timer peripheral.
/// @param  autoReload: specifies the Counter register new value.
/// @retval None.
////////////////////////////////////////////////////////////////////////////////
void TIM_SetAutoreload(TIM_TypeDef* tim, u32 autoReload)
{
    WRITE_REG(tim->ARR, autoReload);
}

////////////////////////////////////////////////////////////////////////////////
/// @brief  Sets the timer Input Capture 1 prescaler.
/// @param  tim: where timer can be 1, 2, 3, 4, 5, 8, 14, 16 or 17 to select the
///         timer peripheral.
...
////////////////////////////////////////////////////////////////////////////////
/// @brief  Sets the timer Input Capture 2 prescaler.
/// @param  tim: where timer can be 1, 2, 3, 4, 5 or 8 to select the timer
///         peripheral.
...
////////////////////////////////////////////////////////////////////////////////
/// @brief  Sets the timer Input Capture 3 prescaler.
/// @param  tim: where timer can be 1, 2, 3, 4, 5 or 8 to select the timer
///         peripheral.
...
////////////////////////////////////////////////////////////////////////////////
/// @brief  Sets the timer Input Capture 4 prescaler.
/// @param  tim: where timer can be 1, 2, 3, 4, 5 or 8 to select the timer
///         peripheral.
...
////////////////////////////////////////////////////////////////////////////////
/// @brief  Sets the timer Clock Division value.
/// @param  tim: where timer can be 1, 2, 3, 4, 5, 8, 14, 16 or 17 to select the
///         timer peripheral.
...
/// @retval None.
////////////////////////////////////////////////////////////////////////////////
void TIM_SetClockDivision(TIM_TypeDef* tim, TIMCKD_TypeDef clockDiv)
{
    MODIFY_REG(tim->CR1, TIM_CR1_CKD, clockDiv);
}
...
{
    WRITE_REG(tim->CNT, counter);
}

////////////////////////////////////////////////////////////////////////////////
/// @brief  Sets the timer Capture Compare1 Register value
/// @param  tim: where timer can be 1, 2, 3, 4, 5, 8, 14, 16 or 17 to select the
///         timer peripheral.
...
{
    WRITE_REG(tim->CCR1, compare);
}

////////////////////////////////////////////////////////////////////////////////
/// @brief  Sets the timer Capture Compare2 Register value
/// @param  tim: where timer can be 1, 2, 3, 4, 5 or 8 to select the timer
///         peripheral.
...
{
    WRITE_REG(tim->CCR2, compare);
}

////////////////////////////////////////////////////////////////////////////////
/// @brief  Sets the timer Capture Compare3 Register value
/// @param  tim: where timer can be 1, 2, 3, 4, 5 or 8 to select the timer
///         peripheral.
...
{
    WRITE_REG(tim->CCR3, compare);
}

////////////////////////////////////////////////////////////////////////////////
/// @brief  Sets the timer Capture Compare4 Register value
/// @param  tim: where timer can be 1, 2, 3, 4, 5 or 8 to select the timer
///         peripheral.
...
{
    WRITE_REG(tim->CCR4, compare);
}

////////////////////////////////////////////////////////////////////////////////
/// @brief  Gets the timer Input Capture 1 value.
/// @param  tim: where timer can be 1, 2, 3, 4, 5, 8, 14, 16 or 17 to select the
///         timer peripheral.
...
////////////////////////////////////////////////////////////////////////////////
/// @brief  Gets the timer Input Capture 3 value.
/// @param  tim: where timer can be 1, 2, 3, 4, 5 or 8 to select the timer
///         peripheral.
...
////////////////////////////////////////////////////////////////////////////////
/// @brief  Gets the timer Input Capture 4 value.
/// @param  tim: where timer can be 1, 2, 3, 4, 5 or 8 to select the timer
///         peripheral.
...
////////////////////////////////////////////////////////////////////////////////
/// @brief  Gets the timer Counter value.
/// @param  tim: where timer can be 1, 2, 3, 4, 5, 8, 14, 16 or 17 to select the
///         timer peripheral.
...
////////////////////////////////////////////////////////////////////////////////
/// @brief  Gets the timer Prescaler value.
/// @param  tim: where timer can be 1, 2, 3, 4, 5, 8, 14, 16 or 17 to select the
///         timer peripheral.
...
////////////////////////////////////////////////////////////////////////////////
/// @brief  Checks whether the specified timer flag is set or not.
/// @param  tim: where timer can be 1, 2, 3, 4, 5, 8, 14, 16 or 17 to select the
///         timer peripheral.
/// @param  flag: specifies the flag to check.
///         This parameter can be one of the following values:
///    @arg TIM_FLAG_Update: timer update Flag
///    @arg TIM_FLAG_CC1: timer Capture Compare 1 Flag
///    @arg TIM_FLAG_CC2: timer Capture Compare 2 Flag
///    @arg TIM_FLAG_CC3: timer Capture Compare 3 Flag
///    @arg TIM_FLAG_CC4: timer Capture Compare 4 Flag
///    @arg TIM_FLAG_COM: timer Commutation Flag
///    @arg TIM_FLAG_Trigger: timer Trigger Flag
///    @arg TIM_FLAG_Break: timer Break Flag
///    @arg TIM_FLAG_CC1OF: timer Capture Compare 1 overcapture Flag
///    @arg TIM_FLAG_CC2OF: timer Capture Compare 2 overcapture Flag
///    @arg TIM_FLAG_CC3OF: timer Capture Compare 3 overcapture Flag
///    @arg TIM_FLAG_CC4OF: timer Capture Compare 4 overcapture Flag
/// @note
...
////////////////////////////////////////////////////////////////////////////////
/// @brief  Clears the timer pending flags.
/// @param  tim: where timer can be 1, 2, 3, 4, 5, 8, 14, 16 or 17 to select the
///         timer peripheral.
...
/// @param  tim: where timer can be 1, 2, 3, 4, 5, 8, 14, 16 or 17 to select the
///         timer peripheral.
/// @param  it: specifies the timer interrupt source to check.
///         This parameter can be one of the following values:
///    @arg TIM_IT_Update: timer update Interrupt source
///    @arg TIM_IT_CC1: timer Capture Compare 1 Interrupt source
///    @arg TIM_IT_CC2: timer Capture Compare 2 Interrupt source
...
////////////////////////////////////////////////////////////////////////////////
/// @brief  Clears the timer interrupt pending bits.
/// @param  tim: where timer can be 1, 2, 3, 4, 5, 8, 14, 16 or 17 to select the
///         timer peripheral.
...
/// @retval None.
////////////////////////////////////////////////////////////////////////////////
void TIM_ClearITPendingBit(TIM_TypeDef* tim, TIMIT_TypeDef it)
{
    CLEAR_BIT(tim->SR, it);
}
...
////////////////////////////////////////////////////////////////////////////////
/// @brief  Gets the timer Input Capture 5 value.
/// @param  tim: where timer can be 1 or 8 to select the timer peripheral.
...
////////////////////////////////////////////////////////////////////////////////
/// @brief  Initializes the timer Channel5 according to the specified
///         parameters in the pInitStruct.
/// @param  tim: where timer can be 1 or 8 to select the timer peripheral.
/// @param  pInitStruct: pointer to a TIM_OCInitTypeDef structure that
///			contains the configuration information for the specified timer
...
/// @retval None.
////////////////////////////////////////////////////////////////////////////////
void TIM_OC5Init(TIM_TypeDef* tim, TIM_OCInitTypeDef* pInitStruct)
{
#if defined(CCMR3)
...
///         This parameter can be: ENABLE or DISABLE.
///    @arg ENABLE: Direct output enable, no longer waiting for output after
///         dead time.
...
////////////////////////////////////////////////////////////////////////////////
/// @brief  Enables or disables the specified timer PWM shift /DMA reqeat.
/// @param  tim: select the timer peripheral.
/// @param  it: Specifies the timer PWM shift channel to enable or disable.
///         This parameter can be any combination of the following values:
///    @arg TIM_PDER_CCDREPE:
///         timer DMA reqeat enable bit
///    @arg TIM_PDER_CCR1SHIFTEN:
///         timer Channel 1 output PWM phase shift enable bit
///    @arg TIM_PDER_CCR2SHIFTEN:
///         timer Channel 2 output PWM phase shift enable bit
///    @arg TIM_PDER_CCR3SHIFTEN:
///         timer Channel 3 output PWM phase shift enable bit
///    @arg TIM_PDER_CCR4SHIFTEN:
///         timer Channel 4 output PWM phase shift enable bit
///    @arg TIM_PDER_CCR5SHIFTEN:
///         timer Channel 5 output PWM phase shift enable bit
/// @param  state: new state of the timer interrupts.
///         This parameter can be: ENABLE or DISABLE.
/// @retval None.
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
/// @brief  Sets the timer CCR1 shift Register value
/// @param  tim: TIM1 Must be selected.
/// @param  compare: specifies the Capture Compare1 register new value.
/// @retval None.
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
/// @brief  Sets the timer CCR2 shift Register value
/// @param  tim: TIM1 Must be selected.
/// @param  compare: specifies the Capture Compare1 register new value.
/// @retval None.
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
/// @brief  Sets the timer CCR3 shift Register value
/// @param  tim: TIM1 Must be selected.
/// @param  compare: specifies the Capture Compare1 register new value.
/// @retval None.
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
/// @brief  Sets the timer CCR4 shift Register value
/// @param  tim: TIM1 Must be selected.
/// @param  compare: specifies the Capture Compare1 register new value.
/// @retval None.
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
/// @brief  Sets the timer CCR5 shift Register value
/// @param  tim: TIM1 Must be selected.
/// @param  compare: specifies the Capture Compare1 register new value.
/// @retval None.
////////////////////////////////////////////////////////////////////////////////
...
///         timer Input 1 is selected to be connected to IC1.
///    @arg TIM_ICSelection_IndirectTI:
///         timer Input 1 is selected to be connected to IC2.
///    @arg TIM_ICSelection_TRC:
///         timer Input 1 is selected to be connected to TRC.
...
///         This parameter can be one of the following values:
///    @arg TIM_ICSelection_DirectTI:
///         timer Input 2 is selected to be connected to IC2.
///    @arg TIM_ICSelection_IndirectTI:
///         timer Input 2 is selected to be connected to IC1.
///    @arg TIM_ICSelection_TRC:
///         timer Input 2 is selected to be connected to TRC.
/// @param  filter: Specifies the Input Capture Filter.
///         This parameter must be a value between 0x00 and 0x0F.
/// @retval None.
////////////////////////////////////////////////////////////////////////////////
...
///         This parameter can be one of the following values:
///    @arg TIM_ICSelection_DirectTI:
///         timer Input 3 is selected to be connected to IC3.
///    @arg TIM_ICSelection_IndirectTI:
///         timer Input 3 is selected to be connected to IC4.
///    @arg TIM_ICSelection_TRC:
///         timer Input 3 is selected to be connected to TRC.
/// @param  filter: Specifies the Input Capture Filter.
///         This parameter must be a value between 0x00 and 0x0F.
/// @retval None.
////////////////////////////////////////////////////////////////////////////////
...
///         This parameter can be one of the following values:
///    @arg TIM_ICSelection_DirectTI:
///         timer Input 4 is selected to be connected to IC4.
///    @arg TIM_ICSelection_IndirectTI:
///         timer Input 4 is selected to be connected to IC3.
///    @arg TIM_ICSelection_TRC:
///         timer Input 4 is selected to be connected to TRC.
/// @param  filter: Specifies the Input Capture Filter.
///         This parameter must be a value between 0x00 and 0x0F.
/// @retval None.
////////////////////////////////////////////////////////////////////////////////
