...
void DMA_StructInit(DMA_InitTypeDef* pInitStruct)
{
    ...
    pInitStruct->PeripheralInc      = DMA_PeripheralInc_Enable;
    pInitStruct->MemoryInc          = DMA_MemoryInc_Enable;
    pInitStruct->PeripheralDataSize = DMA_PeripheralDataSize_Word;
    pInitStruct->MemoryDataSize     = DMA_MemoryDataSize_Word;
    pInitStruct->Mode               = DMA_Mode_Normal;
    pInitStruct->Priority           = DMA_Priority_High;
