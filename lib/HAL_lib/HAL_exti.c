...
{
    *(u32*)(&SYSCFG->EXTICR1 + 0x04 * (EXTI_PinSourcex >> 0x02)) &= ~(0x0F << (0x04 * (EXTI_PinSourcex & 0x03)));
    *(u32*)(&SYSCFG->EXTICR1 + 0x04 * (EXTI_PinSourcex >> 0x02)) |= ((EXTI_PortSourceGPIOx) << (0x04 * (EXTI_PinSourcex & 0x03)));
}
