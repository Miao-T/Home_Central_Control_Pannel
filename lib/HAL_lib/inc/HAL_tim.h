...
typedef enum {
    ...
    TIM_EventSource_CC5     = (int)0x00010000,  				///< Timer Capture Compare 5 Event source
} TIMEGR_Typedef;
...
typedef enum {
    ...
    TIM_LOCKLevel_1   = TIM_BDTR_LOCK_1,    					///< DTG bits in TIMx_BDTR register, OISx and OISxN bits in TIMx_CR2
																///< register and BKE/BKP/AOE bits in tim_BDTR register can no longer be written.
    TIM_LOCKLevel_2 = TIM_BDTR_LOCK_2,      					///< LOCK Level 1 + CC Polarity bits (CCxP/CCxNP bits in tim_CCER
    ...
    TIM_LOCKLevel_3 = TIM_BDTR_LOCK_3       					///< LOCK Level 2 + CC Control bits (OCxM and OCxPE bits in tim_CCMRx registers,
