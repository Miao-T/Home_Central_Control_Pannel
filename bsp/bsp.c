...
/// 		@arg 	AFIO_MAPR_PD01              : SPI1 Alternate Function mapping
/// 		@arg 	AFIO_MAPR_I2C1              : I2C1 Alternate Function mapping
/// 		@arg 	AFIO_MAPR_UART1             : UART1 Alternate Function mapping
/// 		@arg 	AFIO_MAPR_UART3             : UART3 Full Alternate Function
/// 				mapping
/// 		@arg 	AFIO_MAPR_TIM1_PARTIAL      : TIM1 Partial Alternate Function
/// 				mapping
/// 		@arg 	AFIO_MAPR_TIM1              : TIM1 Full Alternate Function
/// 				mapping
/// 		@arg 	AFIO_MAPR_TIM2_PARTIAL1     : TIM2 Partial1 Alternate Function
/// 				mapping
/// 		@arg 	AFIO_MAPR_TIM2_PARTIAL2     : TIM2 Partial2 Alternate Function
/// 				mapping
/// 		@arg 	AFIO_MAPR_TIM2              : TIM2 Full Alternate Function
/// 				mapping
/// 		@arg 	AFIO_MAPR_TIM3_PARTIAL      : TIM3 Partial Alternate Function
/// 				mapping
/// 		@arg 	AFIO_MAPR_TIM3              : TIM3 Full Alternate Function
/// 				mapping
/// 		@arg 	AFIO_MAPR_CAN               : CAN1 Alternate Function mapping
/// 		@arg 	AFIO_MAPR_PD01              : PD01 Alternate Function mapping
/// 		@arg 	AFIO_MAPR_SWJ_NOJNTRST      : Full SWJ Enabled (JTAG-DP + SW-DP)
/// 				but without JTRST
/// 		@arg 	AFIO_MAPR_SWJ_JTAGDISABLE   : JTAG-DP Disabled and SW-DP Enabled
/// 		@arg 	AFIO_MAPR_SWJ_DISABLE       : Full SWJ Disabled (JTAG-DP + SW-DP)
...
{
#if (GPIOA_BASE < AHB2PERIPH_BASE)
#if !defined(__MM0T1)
    RCC_APB2PeriphClockCmd(1 << (((u32)port - GPIOA_BASE) / 0x400 + 2), ENABLE);
#endif
#endif
#if (GPIOA_BASE >= AHB2PERIPH_BASE)
    RCC_AHBPeriphClockCmd(1 << (((u32)port - GPIOA_BASE) / 0x400 + 17), ENABLE);
#endif
}
