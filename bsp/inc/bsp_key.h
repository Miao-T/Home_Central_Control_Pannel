...
#define KEY1_BIT GPIO_Pin_2
#define KEY2_BIT GPIO_Pin_13
...
#define KEY1_CONFIG {COMMON_EnableIpClock(emCLOCK_GPIOD);GPIO_Mode_IPD_Init(KEY1_PORT, KEY1_BIT, NO_REMAP, GPIO_AF_0);}
#define KEY2_CONFIG {COMMON_EnableIpClock(emCLOCK_GPIOC);GPIO_Mode_IPU_Init(KEY2_PORT, KEY2_BIT, NO_REMAP, GPIO_AF_0);}
#define KEY3_CONFIG {COMMON_EnableIpClock(emCLOCK_GPIOC);GPIO_Mode_IPU_Init(KEY3_PORT, KEY3_BIT, NO_REMAP, GPIO_AF_0);}
#define KEY4_CONFIG {COMMON_EnableIpClock(emCLOCK_GPIOC);GPIO_Mode_IPU_Init(KEY4_PORT, KEY4_BIT, NO_REMAP, GPIO_AF_0);}
...
#define KEY2_CONFIG {COMMON_EnableIpClock(emCLOCK_GPIOB);GPIO_Mode_IPU_Init(KEY2_PORT, KEY2_BIT, NO_REMAP, GPIO_AF_0);}
#define KEY3_CONFIG {COMMON_EnableIpClock(emCLOCK_GPIOB);GPIO_Mode_IPU_Init(KEY3_PORT, KEY3_BIT, NO_REMAP, GPIO_AF_0);}
#define KEY4_CONFIG {COMMON_EnableIpClock(emCLOCK_GPIOB);GPIO_Mode_IPU_Init(KEY4_PORT, KEY4_BIT, NO_REMAP, GPIO_AF_0);}
    ...
    #define KEY1_CONFIG {COMMON_EnableIpClock(emCLOCK_GPIOB);GPIO_Mode_IPD_Init(KEY1_PORT, KEY1_BIT, NO_REMAP, GPIO_AF_15);}
    #define KEY2_CONFIG {                                    GPIO_Mode_IPU_Init(KEY2_PORT, KEY2_BIT, NO_REMAP, GPIO_AF_15);}
    #define KEY3_CONFIG {                                    GPIO_Mode_IPU_Init(KEY3_PORT, KEY3_BIT, NO_REMAP, GPIO_AF_15);}
    #define KEY4_CONFIG {                                    GPIO_Mode_IPU_Init(KEY4_PORT, KEY4_BIT, NO_REMAP, GPIO_AF_15);}
...
GLOBAL u16               keyDelayCnt2[4]     = {0, 0, 0, 0};
GLOBAL bool              keyDelayFlag[4]     = {false, false, false, false};
GLOBAL bool              keyDoubleFlag[4]    = {false, false, false, false};
...
#endif
GLOBAL u16               keyStateMachine[4];
GLOBAL u16               keyDelayCnt[4];
GLOBAL bool              keyDoubleFlag[4];
GLOBAL bool              keyclkFlag[4];
