...
/// @{
    ...
    #define LED5_CONFIG {                                    GPIO_SetBits(LED5_PORT, LED5_BIT);GPIO_Mode_OUT_OD_20MHz_Init(LED5_PORT, LED5_BIT, AFIO_MAPR_SWJ_JTAGDISABLE, GPIO_AF_0);}
...
#define LED3_BIT    GPIO_Pin_3
#define LED4_BIT    GPIO_Pin_4

#define LED1_CONFIG {COMMON_EnableIpClock(emCLOCK_GPIOD);GPIO_SetBits(LED1_PORT, LED1_BIT); GPIO_Mode_OUT_OD_20MHz_Init(LED1_PORT, LED1_BIT, NO_REMAP, GPIO_AF_0);}
#define LED2_CONFIG {COMMON_EnableIpClock(emCLOCK_GPIOA);GPIO_SetBits(LED2_PORT, LED2_BIT); GPIO_Mode_OUT_OD_20MHz_Init(LED2_PORT, LED2_BIT, NO_REMAP, GPIO_AF_0);}
#define LED3_CONFIG {COMMON_EnableIpClock(emCLOCK_GPIOB);GPIO_SetBits(LED3_PORT, LED3_BIT); GPIO_Mode_OUT_OD_20MHz_Init(LED3_PORT, LED3_BIT, NO_REMAP, GPIO_AF_0);}
#define LED4_CONFIG {COMMON_EnableIpClock(emCLOCK_GPIOB);GPIO_SetBits(LED4_PORT, LED4_BIT); GPIO_Mode_OUT_OD_20MHz_Init(LED4_PORT, LED4_BIT, NO_REMAP, GPIO_AF_0);}
...
#define LED2_BIT    GPIO_Pin_10
#define LED3_BIT    GPIO_Pin_11
...
#define LED2_CONFIG {COMMON_EnableIpClock(emCLOCK_GPIOC);GPIO_SetBits(LED2_PORT, LED2_BIT); GPIO_Mode_OUT_OD_20MHz_Init(LED2_PORT, LED2_BIT, NO_REMAP, GPIO_AF_0);}
#define LED3_CONFIG {COMMON_EnableIpClock(emCLOCK_GPIOC);GPIO_SetBits(LED3_PORT, LED3_BIT); GPIO_Mode_OUT_OD_20MHz_Init(LED3_PORT, LED3_BIT, NO_REMAP, GPIO_AF_0);}
#define LED4_CONFIG {COMMON_EnableIpClock(emCLOCK_GPIOC);GPIO_SetBits(LED4_PORT, LED4_BIT); GPIO_Mode_OUT_OD_20MHz_Init(LED4_PORT, LED4_BIT, NO_REMAP, GPIO_AF_0);}
...
#define YELLOW_LED_OFF      LD4_off
    ...
    #define LED1_CONFIG {COMMON_EnableIpClock(emCLOCK_GPIOA);GPIO_SetBits(LED1_PORT, LED1_BIT); GPIO_Mode_OUT_OD_20MHz_Init(LED1_PORT, LED1_BIT, NO_REMAP, GPIO_AF_0);}
#if defined(__MM3U1)
    #define LED2_CONFIG {COMMON_EnableIpClock(emCLOCK_GPIOB);GPIO_SetBits(LED2_PORT, LED2_BIT); GPIO_Mode_OUT_OD_20MHz_Init(LED2_PORT, LED2_BIT, NO_REMAP, 0xF);}
#else
    #define LED2_CONFIG {COMMON_EnableIpClock(emCLOCK_GPIOB);GPIO_SetBits(LED2_PORT, LED2_BIT); GPIO_Mode_OUT_OD_20MHz_Init(LED2_PORT, LED2_BIT, NO_REMAP, GPIO_AF_0);}
#endif
